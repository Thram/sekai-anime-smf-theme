...
function template_main() {
    ...
    if ($context['simple_search']) {
        ...
        if (empty($modSettings['search_simple_fulltext'])) echo '
...
function template_results() {
	...
	<div id="search_results">
        ...
        if (isset($context['did_you_mean'])) echo '
        ...
        if (!empty($context['search_params']['brd'])) foreach ($context['search_params']['brd'] as $board_id) echo '
            ...
            foreach ($topic['matches'] as $message) {
                ...
                if (!empty($options['display_quick_mod'])) {
                    ...
                    if ($options['display_quick_mod'] == 1) {
                        ...
                        if ($topic['quick_mod']['remove']) echo '
                        ...
                        if ($topic['quick_mod']['lock'] || $topic['quick_mod']['remove']) echo '
						<br />';

                        if ($topic['quick_mod']['sticky']) echo '
